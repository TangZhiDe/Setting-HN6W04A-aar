package com.adayo.commonui.tablayout;
...
import com.adayo.commonui.tablayout.listener.CustomTabEntity;
import com.adayo.commonui.tablayout.listener.OnTabSelectListener;
import com.adayo.commonui.tablayout.utils.FragmentChangeManager;
import com.adayo.commonui.tablayout.utils.UnreadMsgUtils;
import com.adayo.commonui.tablayout.widget.MsgView;
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (mIconVisible) {
                if (iconH <= 0) {
                    if((mContext.getResources() == null) ||(mContext.getResources().getDrawable(mTabEntitys.get(position).getTabSelectedIcon()) == null)){
                        return;
                    }
