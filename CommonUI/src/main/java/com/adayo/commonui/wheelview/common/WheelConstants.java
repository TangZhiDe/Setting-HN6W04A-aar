 ...
 */
package com.adayo.commonui.wheelview.common;
...
//    public static final int WHEEL_SKIN_COMMON_BG = Color.parseColor("#dddddd");
    public static final int WHEEL_SKIN_COMMON_BG = Color.WHITE;
...
//    public static final int WHEEL_SKIN_COMMON_DIVIDER_COLOR = Color.parseColor("#b5b5b5");
    public static final int WHEEL_SKIN_COMMON_DIVIDER_COLOR = Color.WHITE;

    /**
     * common皮肤左右边框颜色
     */
    public static final int WHEEL_SKIN_COMMON_BORDER_COLOR = Color.WHITE;
