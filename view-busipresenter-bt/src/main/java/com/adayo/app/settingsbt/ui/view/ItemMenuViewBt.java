package com.adayo.app.settingsbt.ui.view;
 ...
 * @date 2018-07-27.
 */
public class ItemMenuViewBt extends RelativeLayout implements View.OnClickListener {
    ...
    private SwitchButtonBt mSwitchButtonView;
    ...
    public ItemMenuViewBt(Context context) {
        this(context, null);
    }

    public ItemMenuViewBt(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemMenuViewBt(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ItemMenuViewBt);
        mShowSwitchButton = typedArray.getBoolean(R.styleable.ItemMenuViewBt_showSwitchButton, false);
        mSwitchButtonState = typedArray.getBoolean(R.styleable.ItemMenuViewBt_switchButtonState, false);
        mSwitchButtonWidth = (int) typedArray.getDimension(R.styleable.ItemMenuViewBt_switchButtonWidth, 38);

        mLeftText = typedArray.getText(R.styleable.ItemMenuViewBt_text);
        mTextSize = (int) typedArray.getDimension(R.styleable.ItemMenuViewBt_textSize, 26);
        mTextColor = typedArray.getColor(R.styleable.ItemMenuViewBt_textColor, Color.parseColor("#000000"));
    ...
    private void initView() {
        ...
        mSwitchButtonView = new SwitchButtonBt(getContext());
